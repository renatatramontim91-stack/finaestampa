(() => {
  ...
  addBeforeFaq('depoimentos', 'showcase-dark testimonials', '<div class="wrap"><div class="showcase-title"><h2>Avalia&ccedil;&otilde;es reais no <em>Google</em></h2><p>As avalia&ccedil;&otilde;es abaixo s&atilde;o atualizadas diretamente pelo Google.</p></div><div class="elfsight-app-cca2dff7-aec0-4f55-9de4-fa2724489171" data-elfsight-app-lazy></div></div>');
